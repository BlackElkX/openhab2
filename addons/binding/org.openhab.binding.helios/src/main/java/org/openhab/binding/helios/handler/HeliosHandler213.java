...
public class HeliosHandler213 extends BaseThingHandler {
    ...
    private ScheduledFuture<?> postInitJob;
    ...
    public void initialize() {
        ...
        if (ipAddress != null && !ipAddress.isEmpty() && username != null && !username.isEmpty() && password != null
            ...
            if (jsonObject.get("success").toString().equals("true")) {
                ...
                if (postInitJob == null || postInitJob.isCancelled()) {
                    postInitJob = scheduler.schedule(postInitRunnable, 1, TimeUnit.SECONDS);
                }
    ...
    protected Runnable postInitRunnable = new Runnable() {
        ...
        public void run() {
            while (getThing().getStatus() != ThingStatus.ONLINE) {
                try {
                    ...
                    logger.debug("The post initalization thread was interrupted : '{}'", e.getMessage(), e);
                }
            }
